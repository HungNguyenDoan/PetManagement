...
import com.project.petmanagement.activity.schedule.careactivity.SetCareActivityScheduleActivity;
...
public class SelectPetActivityAdapter extends RecyclerView.Adapter<SelectPetActivityAdapter.PetViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PetViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(v -> {
            if(action != null){
                Intent intent = new Intent(context, SetCareActivityScheduleActivity.class);
