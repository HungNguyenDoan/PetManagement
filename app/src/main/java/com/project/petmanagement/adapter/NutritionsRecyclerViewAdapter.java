...
public class NutritionsRecyclerViewAdapter extends  RecyclerView.Adapter<NutritionsRecyclerViewAdapter.NutritionsViewHolder>{
    private List<NutritionsInfor> nutritionsInforList;
    private Context context;
    public NutritionsRecyclerViewAdapter(Context context, List<NutritionsInfor> nutritionsInforList){
    ...
    public void onBindViewHolder(@NonNull NutritionsViewHolder holder, int position) {
        NutritionsInfor nutritionsInfor = nutritionsInforList.get(position);
