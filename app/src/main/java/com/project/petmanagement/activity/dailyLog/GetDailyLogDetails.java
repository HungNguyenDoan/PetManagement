...
public class GetDailyLogDetails extends AppCompatActivity {
    private long logId;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_daily_log);
        initView();
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), UpdateDailyLog.class);
    ...
    private void getDailyLog() {
        ApiService.apiService.getDailyLogById(logId).enqueue(new Callback<DailyActivityLogResponse>() {
            ...
            public void onFailure(Call<DailyActivityLogResponse> call, Throwable t) {
                Toast.makeText(GetDailyLogDetails.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void deleteDailyLog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(GetDailyLogDetails.this);
        alertDialog.setTitle("Thông báo")
                ...
                .setPositiveButton("Có", (dialog, which) -> {
                    ApiService.apiService.deleteDailyLog(logId).enqueue(new Callback<DailyActivityLogResponse>() {
                        ...
                        public void onResponse(Call<DailyActivityLogResponse> call, Response<DailyActivityLogResponse> response) {
                            if (response.isSuccessful()) {
                                Toast.makeText(GetDailyLogDetails.this, "Xóa thành công.", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }
