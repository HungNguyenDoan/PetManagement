...
public class CareActivityScheduleDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEditActivityInfo.setOnClickListener(v -> {
            Intent intent = new Intent(CareActivityScheduleDetailActivity.this, UpdateCareActivityInfoActivity.class);
        ...
        btnEditRecurringSchedule.setOnClickListener(v -> {
            Intent intent = new Intent(CareActivityScheduleDetailActivity.this, UpdateCareActivityNotificationActivity.class);
            intent.putExtra("recurringScheduleRequest", recurringScheduleRequest);
            startActivity(intent);
        });
        btnDelete.setOnClickListener(v -> {
            AlertDialog.Builder arlertDialog = new AlertDialog.Builder(CareActivityScheduleDetailActivity.this);
                        ...
                        ApiService.apiService.deleteCareActivityNotification(careActivityNotification.getId()).enqueue(new Callback<com.project.petmanagement.payloads.responses.Response>() {
                            ...
                            public void onResponse(Call<com.project.petmanagement.payloads.responses.Response> call, Response<com.project.petmanagement.payloads.responses.Response> response) {
                                if (response.isSuccessful()) {
                                    Toast.makeText(CareActivityScheduleDetailActivity.this, "Xóa thông báo thành công.", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                            }
