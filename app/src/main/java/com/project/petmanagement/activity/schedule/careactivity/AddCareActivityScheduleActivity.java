...
public class AddCareActivityScheduleActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEditActivityInfo.setOnClickListener(v -> {
            Intent intent = new Intent(AddCareActivityScheduleActivity.this, AddCareActivityInfoActivity.class);
        ...
        btnEditRecurringSchedule.setOnClickListener(v -> {
            Intent intent = new Intent(AddCareActivityScheduleActivity.this, AddCareActivityNotificationActivity.class);
        ...
        btnSelectPet.setOnClickListener(v -> {
            Intent intent = new Intent(AddCareActivityScheduleActivity.this, SelectPetToActivityActivity.class);
        ...
        saveActivityScheduleBtn.setOnClickListener(v -> {
            ...
            ApiService.apiService.addCareActivityNotification(careActivityNotificationRequest).enqueue(new Callback<CareActivityNotificationResponse>() {
                ...
                public void onFailure(Call<CareActivityNotificationResponse> call, Throwable t) {
                    Toast.makeText(AddCareActivityScheduleActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        });
        setButtonSave();
