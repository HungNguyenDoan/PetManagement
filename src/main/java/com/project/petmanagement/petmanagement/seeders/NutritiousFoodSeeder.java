...
public class NutritiousFoodSeeder {
        ...
        public void seed() {
                ...
                NutritiousFood nutri1 = NutritiousFood.builder().id(1L)
...
//                nutri8.setFoodType(listFoodTypes.get(8));
                ...
                NutritiousFood nutri10 = NutritiousFood.builder().id(10L).name("TastyTreats Cheese Delight")
                                .description("Semi-moist treats with a cheese flavor, ideal for training sessions.")
                                .build();
                nutri10.setFoodType(listFoodTypes.get(9));
                NutritiousFoodRepository
                                .saveAll(Arrays.asList(new NutritiousFood[] { nutri1, nutri2, nutri3, nutri4, nutri5,
